exports.install = function (Vue, options) {
  ...
  Vue.prototype.linkINewsURL = 'http://inewsengine.com/api/asserver/JGauthorize'; //华为云环境__跳转inewsURL


  // Vue.prototype.searchURL = 'http://inewsengine.com/api/asserver/JGauthorize'; //测试环境环境__搜索URL
  // Vue.prototype.searchURL = 'http://inewsengine.com'; //华为云环境__搜索URL
  ...
  /*生成报告(新)*/
  Vue.prototype.createReportNewParamsMap = [];

  Vue.prototype.registerCreateReportNewParams = function (param) {

    this.createReportNewParamsMap = param;
  }
};
